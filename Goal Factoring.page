...
First, grab a pencil and a piece of paper (or, if you're feeling fancy, [yEd](Setting Up yEd)). At the top of the page, start by jotting down an activity you seem to spend a lot of time doing, but don't particularly enjoy. My particular example was **spending time on facebook**.
...
[Geoff Anders](http://www.leverageresearch.org/) says that 10h worth of goal factoring should be sufficient to notice significant benefits from this technique, and that 50h should fully exhaust your mind of goal structure.
